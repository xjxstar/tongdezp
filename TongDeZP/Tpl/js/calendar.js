...
Calendar.prototype.show = function(dateControl, popuControl) {
  ...
  this.bindYear();
  this.bindMonth();
  if (dateControl.value.length > 0 && dateControl.value!='选择/修改') {
...
var divs = [];
divs[divs.length] = '<div id="__calendarPanel" style="position:absolute;display:none;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:225px;">';
